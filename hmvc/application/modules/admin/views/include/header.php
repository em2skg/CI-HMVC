...
<html lang="en">
    <head>
        ...
        <script>
            var full_path = '<?php echo base_url('assets') ?>/';
        </script>
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        ...
                        <a class="brand" href="index.php"> <img alt="Charisma Logo" src="<?php echo base_url('assets') ?>/img/logo20.png" /> <span>Charisma</span></a>
